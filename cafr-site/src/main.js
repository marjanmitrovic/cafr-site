  ...
  document.querySelector('#app').innerHTML = `
    ...
    <main>
      ...
      <section class="section" id="education">
        ...
        <div class="grid news">
          <article>
            <small>8. 7. 2026</small>
            <h3>
              ${
                lang === 'cs'
                  ? 'Fotbal bez vesnice: problém, který se týká i rozhodčích'
                  : 'Football without villages: a problem that also affects referees'
              }
            </h3>
            <p>
              ${
            ...
            <a
              class="news-link"
              href="https://medium.seznam.cz/clanek/jan-markes-fotbal-bez-vesnice-tichy-rozklad-hry-ktera-drzela-cesko-pohromade-294979"
              target="_blank"
              rel="noopener noreferrer"
            >
              ${lang === 'cs' ? 'Přečíst článek' : 'Read the article'} →
            </a>
          </article>

          <article>
            <small>11. 7. 2026</small>
            <h3>
              ${
                lang === 'cs'
            ...
            <p>
              ${
                lang === 'cs'
                  ? 'Do dokumentů byl vložen aktualizovaný návrh stanov s úpravou prvního Výkonného výboru, Generálního sekretáře a Revizní komise.'
                  : 'The document library now includes the updated draft statutes with provisions on the first Executive Committee, the General Secretary and the Audit Committee.'
              }
            </p>
            <a
              class="news-link"
              href="/documents/Stanovy_CAFR_aktualizovane.pdf"
              target="_blank"
              rel="noopener noreferrer"
            >
              ${lang === 'cs' ? 'Otevřít stanovy' : 'Open statutes'} →
            </a>
          </article>
    ...
    <section class="documents-section" id="documents">
      <div>
        ...
        <p>
          ${
            lang === 'cs'
              ? 'Aktualizovaný návrh stanov upravuje cíle, členství, orgány, první Výkonný výbor, Generálního sekretáře a Revizní komisi.'
              : 'The updated draft statutes govern the association’s aims, membership, bodies, the first Executive Committee, the General Secretary and the Audit Committee.'
          }
        </p>
      </div>
      ...
      <a
        ...
        rel="noopener"
      >
        📄 ${lang === 'cs' ? 'Otevřít aktualizované stanovy' : 'Open updated statutes'}
      </a>
    </section>
