  ...
  app.innerHTML = `
    <div class="dashboard-layout">
      <aside class="dashboard-sidebar">
        <a class="dashboard-brand" href="/"><img src="/assets/ucfr-logo.png?v=11" alt="UČFR"><span>UČFR</span></a>
    ...
    target.innerHTML = `
      <section class="dashboard-panel digital-card-panel">
        <div class="digital-member-card">
          <div class="digital-card-head"><img src="/assets/ucfr-logo.png?v=11" alt="UČFR"><span>ČLENSKÝ PRŮKAZ</span></div>
