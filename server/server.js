...
const configuredAdminNotifyEmails = String(process.env.ADMIN_NOTIFY_EMAIL || process.env.ADMIN_EMAIL || '')
  .split(',')
...
app.get('/api/members/verify/:id', async (req, res) => {
  try {
    ...
    return res.json({
      ...
      association: {
        name: process.env.ASSOCIATION_NAME || 'Unie českých fotbalových rozhodčích, z. s.',
